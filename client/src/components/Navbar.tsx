...
export default function Navbar() {
  ...
  return (
    <div className="max-w-md mx-auto fixed bottom-0 left-0 w-full z-10 bg-default-50/90 backdrop-blur-md px-3 border border-b flex items-center justify-between py-3">
      <Link to="/">
